    ...
    magicMouse = function(e) {
        ...
        if (!Modernizr.touchevents) {
            ...
            var u = 0,
                ...
                h = 0,
                p = !1;
            document.addEventListener("mousemove", (function(e) { f = e.clientX, h = e.clientY, setTimeout((function() { p || (u = e.clientX - s / 2, l = e.clientY - a / 2) }), 50) })), document.querySelectorAll(".magic-hover").forEach((function(t, o) {
            ...
            })), document.querySelectorAll(".no-cursor").forEach((function(e, t) { e.addEventListener("mouseenter", (function(e) { n.style.opacity = 0, i.style.opacity = 0, document.body.style.cursor = "auto" })), e.addEventListener("mouseleave", (function(e) { n.style.opacity = 1, i.style.opacity = 1, document.body.style.cursor = "none" })) }));
            requestAnimationFrame((function e() { n && (n.style.transform = "matrix(1, 0, 0, 1, " + u + ", " + l + ")", n.style.width = s + "px", n.style.height = a + "px"), i && (i.style.transform = "matrix(1, 0, 0, 1, " + f + ", " + h + ") translate3d(-50%, -50%, 0)"), requestAnimationFrame(e) }));
            var m = function(e) {
                    if (p = !0, n) {
                ...
                v = function() { p = !1, n && (s = c, a = d, n.style.transition = "transform 0.07s, width 0.3s, height 0.3s, border-radius 0.2s", n.classList.remove("cursor-square"), n.classList.remove("is-hover")), i && i.classList.remove("is-hover") },
                y = function(e, t) { i && i.classList.add(t) },
                g = function(e) { i && i.classList.remove(e) },
                b = function(e, t) { e.clientX, e.clientY, t.addEventListener("mousemove", (function(e) { t.style.transform = "matrix(1,0,0,1," + (e.offsetX - e.target.offsetWidth / 2) / 2 + ", " + (e.offsetY - e.target.offsetHeight / 2) / 2 + ")" })) }
        }
    };
! function(e, t, o) {
    function n(e, t) { return _typeof(e) === t }

    function r() { return "function" != typeof t.createElement ? t.createElement(arguments[0]) : f ? t.createElementNS.call(t, "http://www.w3.org/2000/svg", arguments[0]) : t.createElement.apply(t, arguments) }

    function i() { var e = t.body; return e || ((e = r(f ? "svg" : "body")).fake = !0), e }
    var s = [],
        a = [],
        c = {
            _version: "3.6.0",
            ...
            on: function(e, t) {
                var o = this;
                setTimeout((function() { t(o[e]) }), 0)
            },
            addTest: function(e, t, o) { a.push({ name: e, fn: t, options: o }) },
    ...
    d.addTest("touchevents", (function() {
            ...
            if ("ontouchstart" in e || e.DocumentTouch && t instanceof DocumentTouch) o = !0;
                ...
                h(n, (function(e) { o = 9 === e.offsetTop }))
            }
            return o
        })),
        function() {
